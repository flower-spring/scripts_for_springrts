--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
--  file:    cmd_auto_selfd_the_mines_and_crawling_mines.lua
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
function widget:GetInfo()
    return {
        name = "Auto self-d the mines +crawling mines except with fast units",
...
function widget:Initialize()
    ...
    for _, unitID in pairs(allUnits) do
        ...
        if uDID then
            ...
            if name == "armmine1" or name == "armmine2" or name == "armmine3" or name == "cormine1" or name == "cormine2" or name == "cormine3" or name == "armfmine3" or name == "corfmine3" or name == "cormine4" or name == "armvader" or name == "corroach" or name == "corsktl" then
                mines[unitID] = uDID
            end
        end
    end
...
function widget:UnitTaken(unitID, unitDefID, old_team, new_team)
    local name = UnitDefs[unitDefID].name
    if (name == "armmine1" or name == "armmine2" or name == "armmine3" or name == "cormine1" or name == "cormine2" or name == "cormine3" or name == "armfmine3" or name == "corfmine3" or name == "cormine4" or name == "armvader" or name == "corroach" or name == "corsktl") and new_team == GetMyTeamID() then
        mines[unitID] = unitDefID
    else
        mines[unitID] = nil
    end
